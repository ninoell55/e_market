    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div
                ...
                {{-- Mobile Cart/Action (Hanya muncul di mobile di baris ini) --}}
                <div class="flex lg:hidden items-center">
                    <a href="#" class="relative p-3 text-gray-400 hover:text-rose-600 transition-all">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                        </svg>
                        <span
                            class="absolute top-1 right-1 flex items-center justify-center min-w-4 h-4 bg-rose-600 text-[8px] font-black text-white">03</span>
                    </a>
                </div>
            </div>

            {{-- SECTION: SEARCH (Full width di mobile, Grow di desktop) --}}
            <div
                ...
                @php
                    ...
                    $placeholder = $hasCategory ? 'SEARCH in COLLECTION: ' . $category->category_name : 'SEARCH COLLECTION';
                @endphp
            ...
            {{-- SECTION: ACTIONS (Desktop Only - hidden in mobile because it moved to top bar) --}}
