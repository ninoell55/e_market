    ...
    <div
        ...
        <div class="relative grow flex items-center justify-center group/img">
            ...
            <div class="relative z-10 w-full text-center pointer-events-none select-none">
                <h1
                    class="text-[18vw] font-black text-white uppercase italic tracking-tighter leading-none transition-all duration-700 group-hover/banner:tracking-normal group-hover/banner:opacity-100 opacity-90 drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
    ...
    <div class="min-h-screen bg-white dark:bg-gray-950">
        <div class="p-6 lg:p-12">
            <div class="flex items-end justify-between mb-10 border-b border-gray-100 dark:border-white/5 pb-6">
                <div>
                    <p class="text-2xs font-black text-rose-600 uppercase tracking-[0.4em] mb-2 italic">Product Feed</p>
                    <h3 class="text-3xl font-black uppercase italic tracking-tighter dark:text-white">
                        All <span class="text-gray-300 dark:text-gray-700">/</span> Essentials
                    </h3>
                </div>
                <p class="text-2xs font-bold text-gray-400 uppercase tracking-widest italic text-right">
