<x-admin-layout>
    ...
    <div class="py-10 bg-[#fcfcfc] dark:bg-black min-h-screen">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 px-4 sm:px-0">
                <div class="space-y-1">
                    <h3 class="text-5xl font-black text-gray-900 dark:text-white tracking-tighter uppercase italic">
                        Analytics_Center<span class="text-rose-600">.</span>
                    </h3>
                ...
                <div
                    ...
                    <a href="{{ route('admin.report.pdf', request()->all()) }}"
                        ...
                        <svg class="w-3 h-3 transition-transform group-hover:rotate-12" fill="none"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <span
                            class="text-2xs font-black text-gray-400 uppercase tracking-[0.3em]">Top_Performing</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <span
                            class="text-2xs font-black text-gray-400 uppercase tracking-[0.3em]">Under_Performing</span>
                    </div>
                    <div class="space-y-6 grow">
                        @forelse($slowMoving as $slow)
                            <div
                                class="flex justify-between items-center opacity-60 hover:opacity-100 transition-opacity">
                                <span
