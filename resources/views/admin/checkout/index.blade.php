    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 px-4 sm:px-0">
                <div>
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white tracking-tighter uppercase italic">
                        Order_Manifest<span class="text-rose-600">.</span>
                    </h3>
            ...
            <div
                ...
                <form action="{{ route('admin.checkout.index') }}" method="GET"
                    ...
                    <div class="flex flex-col gap-2">
                        <label
                            class="text-[9px] font-black uppercase text-gray-400 ml-2 tracking-widest">Sort_By</label>
                        <select name="sort"
                            class="bg-gray-50 dark:bg-gray-900 border-none rounded-xl text-xs font-bold dark:text-white focus:ring-rose-500">
                                ...
                                <tr>
                                    <td colspan="5" class="py-24 text-center">
                                        <div class="flex flex-col items-center opacity-20">
                                            ...
                                            <span
                                                class="text-xs font-black uppercase tracking-[1em]">Empty_Manifest</span>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
