            ...
            <div class="px-4 sm:px-0 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <a href="{{ route('admin.checkout.index') }}"
                        class="group text-2xs font-black text-gray-400 hover:text-rose-600 transition-all uppercase tracking-[0.2em] flex items-center gap-2 mb-4">
                    ...
                    <h3 class="text-4xl font-black text-gray-900 dark:text-white tracking-tighter uppercase italic">
                        Order_Detail<span class="text-rose-600">.</span>
                    </h3>
                ...
                <div
                    class="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 px-6 py-3 rounded-2xl border border-gray-100 dark:border-gray-800">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-8">
                                    ...
                                    <div class="flex justify-between items-center group">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <span
                                                    class="text-2xs font-bold text-gray-400 uppercase tracking-widest">
                    ...
                    <div
                        ...
                        <div>
                            <span
                                class="text-2xs font-black text-gray-400 uppercase tracking-widest block mb-2 italic">//
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div
                        class="bg-gray-900 dark:bg-white p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                        ...
                        <div
                            ...
                            @else
                                <div class="w-full h-full flex flex-col items-center justify-center opacity-20 italic">
                                    ...
                                    <span
                                        class="text-[9px] font-black uppercase tracking-widest">No_Physical_Proof</span>
                                </div>
                            @endif
                        </div>
